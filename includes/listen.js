...
logger("┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓", "[ Minato ]");
  for(let i = 0; i <= admin.length -1; i++){
    dem = i + 1
    logger(` ID ADMIN ${dem}: ${(!admin[i]) ? "Trống" : admin[i]}`, "[ Minato ]");
  }
  logger(` ID BOT: ${api.getCurrentUserID()}`, "[ Minato ]");
  logger(` PREFIX: ${global.config.PREFIX}`, "[ Minato ]");
  logger(` NAME BOT: ${(!global.config.BOTNAME) ? "Minato Minato" : global.config.BOTNAME}`, "[ Minato ]");
  logger("┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛", "[ Minato ]");
  /////////////////////////////////////////////
